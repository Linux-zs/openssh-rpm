...
pushd ../openssl-3.5.3
./config --prefix=%{_prefix} --openssldir=/etc/pki/tls no-shared  no-dso no-tests
make -j$(nproc)
make install_sw
popd
...
export CFLAGS="-I/root/rpmbuild/BUILD/openssl-3.5.3/include -fPIC"
export LDFLAGS="-L/root/rpmbuild/BUILD/openssl-3.5.3 -Wl,-z,relro -Wl,-z,now -Wl,-z,noexecstack -pie"
export LIBS="/root/rpmbuild/BUILD/openssl-3.5.3/libcrypto.a \
             /root/rpmbuild/BUILD/openssl-3.5.3/libssl.a \
             -ldl -lpthread -lz"
%configure \
